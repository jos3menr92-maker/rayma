  ...
  async function handleSave(e) { 
    ...
    try {
      ...
      for (const key of stringFields) {
        // FIX: Send proper 'null' instead of an empty string ("") to prevent 
        // Supabase from crashing on strict data types.
        safePayload[key] = form[key] ? form[key] : null;
      }
      
      // Boolean fields stay boolean
      safePayload.compact_mode = form.compact_mode ?? false;
