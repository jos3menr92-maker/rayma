            ...
            >
              ...
              <div className="bg-accent/10 border-b border-border px-4 py-3 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold font-heading text-foreground">Smart Tips</span>
                  {tips.length > 0 && (
              ...
              <div className="p-4 min-h-[120px] flex items-center justify-center">
                {loading ? (
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <p className="text-xs text-muted-foreground">Analyzing your finances…</p>
                  </div>
                ) : tip ? (
                  ...
                  <p className="text-xs text-muted-foreground text-center">No tips available</p>
                )}
              </div>
