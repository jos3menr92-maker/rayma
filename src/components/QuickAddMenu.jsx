...
export default function QuickAddMenu({ open, onClose }) {
  ...
  const actions = [
    ...
    // 🚀 Streamlined: These now teleport the user directly to the official pages
    ...
    { key: "income", icon: DollarSign, label: "Log Income", color: "bg-green-500/10 text-green-600 border-green-200", action: () => { onClose(); navigate("/income"); } }, 
    ...
    { key: "transaction", icon: ArrowLeftRight, label: "Log Transaction", color: "bg-teal-500/10 text-teal-600 border-teal-200", action: () => { onClose(); navigate("/transactions"); } }, 
  ];
